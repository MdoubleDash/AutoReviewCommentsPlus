 ...
 */
    ...
    var defaultcomments = [
      // SG comments
      {
        ...
        Name: "Elaborate On What Expected",
        Description: "Please [edit] your question to provide more details on what you expected to happen versus what actually happened. This will help readers figure out what didn't work and how to answer your question accordingly."
      },
      {
        Target: [Target.CommentQuestion],
        Name: "Be Specific About Problem",
        Description: "Please [edit] your question to specifically and clearly define the problem that you are trying to solve. Additional details — including all relevant code, error messages, and debugging logs — will help readers to better understand your problem and [what you are asking]."
      },
      {
        Target: [Target.CommentQuestion],
        Name: "Provide Background Research",
        Description: "Please [edit] your question to provide more background details on your problem. Telling readers about your research, what you have already tried, and why it didn't meet your needs will allow them to understand it better."
      },
      {
        Target: [Target.CommentQuestion],
        Name: "Include MRE",
        Description: "Please [edit] your question to include a [mre] so that readers can run your code to answer your question."
      },
      {
        Target: [Target.CommentQuestion],
        Name: "R specific MRE",
      ...
      },
      {
        ...
        Description: "Stack Overflow is an [English-only site](//meta.stackoverflow.com/a/297680). Please try your best to [edit] your question to rewrite it in English."
      },
      {
        Target: [Target.CommentQuestion],
        Name: "Revise Title",
      ...
      },
      {
        ...
        Description: "The lack of proper code formatting makes it difficult for readers to help you. Please [edit] your question to format inline code properly and to use a [code block] for any code or error messages you have included."
      },
      //Advance Flagging comments
      {
        Target: [Target.CommentAnswer],
        Name: "NAA-Comment",
        Description: "This does not provide an answer to the question. Once you have sufficient [reputation](${reputationHelp}) you will be able to [comment on any post](${commentHelp}); instead, [provide answers that don\'t require clarification from the asker](//meta.stackexchange.com/q/214173)."
      },
      {
        Target: [Target.CommentAnswer],
        Name: "NAA-Library",
        Description: "Please don\'t just post some tool or library as an answer. At least demonstrate [how it solves the problem](//meta.stackoverflow.com/a/251605) in the answer itself."
      },
      {
        Target: [Target.CommentAnswer],
        Name: "NAA-Asking Questions",
        Description: "This does not provide an answer to the question. You can [search for similar questions](/search), or refer to the related and linked questions on the right-hand side of the page to find an answer. If you have a related but different question, [ask a new question](/questions/ask), and include a link to this one to help provide context. See: [Ask questions, get answers, no distractions](/tour)"
      },
      {
        Target: [Target.CommentAnswer],
        Name: "NAA-Generic",
        Description: "This post doesn\'t look like an attempt to answer this question. Every post here is expected to be an explicit attempt to *answer* this question; if you have a critique or need a clarification of the question or another answer, you can [post a comment](${commentHelp}) directly below the post. Please remove this answer and create either a comment or a new question. See: [Ask questions, get answers, no distractions](/tour)."
      },
      {
        Target: [Target.CommentAnswer],
        Name: "Duplicate Answer",
        Description: "Please don't add the [same answer to multiple questions](//meta.stackexchange.com/q/104227). If it is not a duplicate, [edit] the answer and tailor the post to the question."
      },
      {
        Target: [Target.CommentAnswer],
        Name: "Link to another answer on SO",
        Description: "Instead of posting an answer which merely links to another answer, please instead [flag the question](${flagPosts}) as a duplicate."
      },
      ...
      },
      {
        ...
        Description: "Please don't add \"thanks\" as answers. Invest some time in the site and you will gain sufficient <a href=\"//$SITEURL$/privileges\">privileges</a> to upvote answers you like, which is [the $SITENAME$ way of saying thank you](https://$SITEURL$/help/someone-answers)."
      },
      {
        Target: [Target.CommentAnswer],
        Name: "OP saying thanks, and just thanks, in the comments",
        Description: "If you have sufficient <a href=\"//$SITEURL$/privileges\">privileges</a>, you should consider ▲upvoting answer(s) you like, which is [the $SITENAME$ way of saying thank you](https://$SITEURL$/help/someone-answers). You can also accept the answer that solved your issue or helped you the most by clicking on the ✔️checkmakr on the left side of the post."
      },
      {
        Target: [Target.CommentQuestion],
        Name: "OP saying thanks, and just thanks, in the comments",
      ...
      },
      {
        ...
        Description: "A link to a solution is welcome, but please ensure your answer is useful without it; [add context around the link](//meta.stackexchange.com/a/8259), include the essential parts of the answer here, and provide the link for reference."
      },
      {
        Target: [Target.CommentAnswer],
      ...
      {
        Target: [Target.CommentAnswer],
        Name: "Should be an edit",
        Description: "Please use the <em>Post answer</em> button only for actual answers. You should modify the original post to add additional information."
      },
      {
        Target: [Target.CommentAnswer],
      ...
      },
      {
        Target: [Target.CommentQuestion],
        Name: "Vandalism",
        Description: "Please do not vandalize your posts. By posting on the Stack Exchange network, you've granted a non-revocable right for SE to distribute that content (under the [CC BY-SA 4.0 license](https://creativecommons.org/licenses/by-sa/4.0/)). By SE policy, any vandalism will be reverted."
      },
      {
        Target: [Target.CommentAnswer],
        Name: "Vandalism",
